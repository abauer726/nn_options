...
def NN_payoff_target(time_step, stock, model, net, NN, convert_in, convert_out, \
                 target, stop = False, display_time = False):
    '''
    ...
    if stop:
        (r_pay, stopT) = NN_payoff_mt(time_step, stock, model, net, NN, convert_in, convert_out, \
                         stop = False, display_time = False)
    else:
        r_pay = NN_payoff_mt(time_step, stock, model, net, NN, convert_in, convert_out, \
                         stop, display_time)
