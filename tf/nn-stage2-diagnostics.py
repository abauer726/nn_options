...
plt.title('Loop 0 Boundary Plot - dt: '+str(coa_dt)+' Price: '+str(np.round(np.mean(r_agg_data_p1),4)))
plt.savefig('Put-Boundary-agg-NN-loop-0-dt-'+str(coa_dt)+'-paths-'+str(data_size)+'-points-'+str(points)+'.png', dpi=1000)
plt.clf()
...
for d in range(1, int(len(x_r_p1)/data_size)):
    ...
    plt.xlabel('Time')
    plt.ylabel('Stock Price')
    plt.title('Loop '+str(d)+' Boundary Plot - dt: '+str(coa_dt)+' Price: '+str(np.round(np.mean(r_agg_data_p1),4)))
...
plt.xlabel('Level')
plt.ylabel('Loop')
plt.title('Put - Squared Diff - Paths: '+str(data_size))
plt.savefig('Put-Stability-sq-diff-dt-'+str(coa_dt)+'-paths-'+str(data_size)+'.png', dpi=1000)
plt.clf()
...
plt.xlabel('Level')
plt.ylabel('Loop')
plt.title('Put - Absolute Diff - Paths: '+str(data_size))
plt.savefig('Put-Stability-abs-diff-dt-'+str(coa_dt)+'-paths-'+str(data_size)+'.png', dpi=1000)
plt.clf()
